...
from common.dto.auth import UserDTO
from common.errors import SecurityBusinessError
...
def register_middleware(app: FastAPI) -> None:
    ...
    with tracer.start_as_current_span("register_middlewares"):
        if hasattr(config, "SENTRY_CONFIG") and config.SENTRY_CONFIG.DSN is not None:
